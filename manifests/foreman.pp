...
#   automatically added.
#   psick_profile::foreman::auto_conf: true
#
...
#   Check psick_profile::foreman::resources_auto_conf_hash in
...
#   Check psick_profile::foreman::options_auto_conf_hash in
#   data/common/foreman.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::foreman::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::foreman::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::foreman::resources
    $resources=lookup('psick_profile::foreman::resources', Hash, $resources_lookup_method, {})
