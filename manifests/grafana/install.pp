# psick_profile::grafana::install
#
# @summary This class manages grafana with Tiny Puppet (tp)
#
...
#         creates: '/opt/grafana'
#   psick_profile::grafana::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::grafana::install::auto_conf: true
#
...
#   Check psick_profile::grafana::install::resources_auto_conf_hash in
...
#   Check psick_profile::grafana::install::options_auto_conf_hash in
#   data/common/grafana.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::grafana::install::resources
...
#
class psick_profile::grafana::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::grafana::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::grafana::install::resources
    $resources=lookup('psick_profile::grafana::install::resources', Hash, $resources_lookup_method, {})
