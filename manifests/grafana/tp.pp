...
#         creates: '/opt/grafana'
#   psick_profile::grafana::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::grafana::tp::auto_conf: true
#
...
#   Check psick_profile::grafana::tp::resources_auto_conf_hash in
...
#   Check psick_profile::grafana::tp::options_auto_conf_hash in
#   data/common/grafana.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::grafana::tp::resources
...
#
class psick_profile::grafana::tp (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::grafana::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::grafana::tp::resources
    $resources=lookup('psick_profile::grafana::tp::resources', Hash, $resources_lookup_method, {})
