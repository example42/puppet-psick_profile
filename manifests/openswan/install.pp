# psick_profile::openswan::install
#
...
#   psick_profile::openswan::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::openswan::install::auto_conf: true
#
...
#   Check psick_profile::openswan::install::resources_auto_conf_hash in
...
#   Check psick_profile::openswan::install::options_auto_conf_hash in
#   data/common/openswan.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::openswan::install::resources
...
#
class psick_profile::openswan::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::openswan::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::openswan::install::resources
    $resources=lookup('psick_profile::openswan::install::resources', Hash, $resources_lookup_method, {})
