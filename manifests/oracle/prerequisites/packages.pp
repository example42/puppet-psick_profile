...
#   psick_profile::oracle::prerequisites::packages::use_defaults: true # Default value
#   psick_profile::oracle::prerequisites::packages::extra_packages:
#     - toad
...
#
class psick_profile::oracle::prerequisites::packages (
