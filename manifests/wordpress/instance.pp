# define psick_profile::wordpress::instance
#
...
define psick_profile::wordpress::instance (
  ...
  $web_server_user  = $::psick_profile::wordpress::web_server_user
  $web_server_group = $::psick_profile::wordpress::web_server_group
