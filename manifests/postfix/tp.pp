...
#         creates: '/opt/postfix'
#   psick_profile::postfix::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::postfix::tp::auto_conf: true
#
...
#   Check psick_profile::postfix::tp::resources_auto_conf_hash in
...
#   Check psick_profile::postfix::tp::options_auto_conf_hash in
#   data/common/postfix.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::postfix::tp::resources
...
#
class psick_profile::postfix::tp (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::postfix::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::postfix::tp::resources
    $resources=lookup('psick_profile::postfix::tp::resources', Hash, $resources_lookup_method, {})
