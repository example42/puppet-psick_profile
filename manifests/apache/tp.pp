...
#   include psick_profile::apache::tp
#
...
#         creates: '/opt/apache'
#   psick_profile::apache::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::apache::tp::auto_conf: true
#
...
#   Check psick_profile::apache::tp::resources_auto_conf_hash in
...
#   Check psick_profile::apache::tp::options_auto_conf_hash in
#   data/common/apache.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::apache::tp::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::apache::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::apache::tp::resources
    $resources=lookup('psick_profile::apache::tp::resources', Hash, $resources_lookup_method, {})
