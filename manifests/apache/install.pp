...
#   include psick_profile::apache::install
#
...
#   psick_profile::apache::install::upstream_repo: true
#
# @example Manage extra configs via hiera (yaml) with templates based on custom options
#   psick_profile::apache::install::ensure: present
...
#         creates: '/opt/apache'
#   psick_profile::apache::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::apache::install::auto_conf: true
#
...
#   Check psick_profile::apache::install::resources_auto_conf_hash in
...
#   Check psick_profile::apache::install::options_auto_conf_hash in
#   data/common/apache.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::apache::install::resources
...
#
class psick_profile::apache::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::apache::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::apache::install::resources
    $resources=lookup('psick_profile::apache::install::resources', Hash, $resources_lookup_method, {})
