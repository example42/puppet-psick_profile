...
# @param users An hash used to create psick_profile::gitlab::user resources
# @param groups An hash used to create psick_profile::gitlab::group resources
# @param projects An hash used to create psick_profile::gitlab::project resources
...
class psick_profile::gitlab (
  ...
  if $manage {
    ...
    if $projects != {} {
      $projects.each |$k,$v| {
        psick_profile::gitlab::project { $k:
          * => $v,
        }
      }
    }
