...
#   psick_profile::puppetdb::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::puppetdb::tp::auto_conf: true
#
...
#   Check psick_profile::puppetdb::tp::resources_auto_conf_hash in
...
#   Check psick_profile::puppetdb::tp::options_auto_conf_hash in
#   data/common/puppetdb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::puppetdb::tp::resources
...
#
class psick_profile::puppetdb::tp (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::puppetdb::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::puppetdb::tp::resources
    $resources=lookup('psick_profile::puppetdb::tp::resources', Hash, $resources_lookup_method, {})
