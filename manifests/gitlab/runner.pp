...
class psick_profile::gitlab::runner (
  ...
  if $runners != {} {
    $runners.each | $k , $v | {
      psick_profile::gitlab::runner_register { $k:
        * => $v,
      }
    }
  }
