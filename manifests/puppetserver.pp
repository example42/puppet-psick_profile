# @class psick_profile::puppetserver
#
class psick_profile::puppetserver (
  ...
  Optional[String]  $r10k_template        = 'psick_profile/puppetserver/r10k.yaml.erb',
  Hash $r10k_options                      = {},
  ...
  String[1] $r10k_postrun_source          = 'puppet:///modules/psick_profile/puppetserver/generate_types.sh',
