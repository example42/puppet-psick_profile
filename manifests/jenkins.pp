...
#    psick::base::linux_classes:
#      jenkins: psick_profile::jenkins
#    psick_profile::jenkins::scm_sync_repository_url: git@github.com:alvagante/jenkins.foss.psick.io-scmsync.git
...
#    psick_profile::jenkins::ssh_private_key_source: puppet:///modules/profile/jenkins/id_rsa
#    psick_profile::jenkins::ssh_public_key_source: puppet:///modules/profile/jenkins/id_rsa.pub
class psick_profile::jenkins (

  Variant[Boolean,String] $ensure            = 'present',
  Enum['psick_profile'] $module               = 'psick_profile',
  Hash $plugins                              = {},
  Hash $init_options                         = {},
  ...
  String $basic_security_template            = 'psick_profile/jenkins/basic-security.groovy.erb',
    ...
    case $module {
      'psick_profile': {
        ...
        tp::conf { 'jenkins::init':
          template     => 'psick_profile/jenkins/init.erb',
