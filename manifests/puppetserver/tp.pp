...
#   psick_profile::puppetserver::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::puppetserver::tp::auto_conf: true
#
...
#   Check psick_profile::puppetserver::tp::resources_auto_conf_hash in
...
#   Check psick_profile::puppetserver::tp::options_auto_conf_hash in
#   data/common/puppetserver.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::puppetserver::tp::resources
...
#
class psick_profile::puppetserver::tp (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::puppetserver::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::puppetserver::tp::resources
    $resources=lookup('psick_profile::puppetserver::tp::resources', Hash, $resources_lookup_method, {})
