...
#         creates: '/opt/mysql'
#   psick_profile::mysql::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::mysql::install::auto_conf: true
#
...
#   Check psick_profile::mysql::install::resources_auto_conf_hash in
...
#   Check psick_profile::mysql::install::options_auto_conf_hash in
#   data/common/mysql.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::mysql::install::resources
...
#
class psick_profile::mysql::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::mysql::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::mysql::install::resources
    $resources=lookup('psick_profile::mysql::install::resources', Hash, $resources_lookup_method, {})
