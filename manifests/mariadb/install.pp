...
#         creates: '/opt/mariadb'
#   psick_profile::mariadb::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::mariadb::install::auto_conf: true
#
...
#   Check psick_profile::mariadb::install::resources_auto_conf_hash in
...
#   Check psick_profile::mariadb::install::options_auto_conf_hash in
#   data/common/mariadb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::mariadb::install::resources
...
#
class psick_profile::mariadb::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::mariadb::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::mariadb::install::resources
    $resources=lookup('psick_profile::mariadb::install::resources', Hash, $resources_lookup_method, {})
