...
class psick_profile::mongo::mms (
  ...
  String                 $monitoring_agent_template = 'psick_profile/mongo/mms/monitoring-agent.config.erb',

  Boolean                $backup_agent_install      = true,
  String                 $backup_agent_template     = 'psick_profile/mongo/mms/backup-agent.config.erb',

  Boolean                $automation_agent_install  = true,
  String                 $automation_agent_template = 'psick_profile/mongo/mms/automation-agent.config.erb',
