# psick_profile::mongo::install
#
# @summary This class manages mongodb with Tiny Puppet (tp)
#
...
#         creates: '/opt/mongodb'
#   psick_profile::mongo::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::mongo::install::auto_conf: true
#
...
#   Check psick_profile::mongo::install::resources_auto_conf_hash in
...
#   Check psick_profile::mongo::install::options_auto_conf_hash in
#   data/common/mongodb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::mongo::install::resources
...
#
class psick_profile::mongo::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::mongo::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::mongo::install::resources
    $resources=lookup('psick_profile::mongo::install::resources', Hash, $resources_lookup_method, {})
