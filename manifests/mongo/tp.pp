...
#         creates: '/opt/mongodb'
#   psick_profile::mongo::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::mongo::tp::auto_conf: true
#
...
#   Check psick_profile::mongo::tp::resources_auto_conf_hash in
...
#   Check psick_profile::mongo::tp::options_auto_conf_hash in
#   data/common/mongodb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::mongo::tp::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::mongo::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::mongo::tp::resources
    $resources=lookup('psick_profile::mongo::tp::resources', Hash, $resources_lookup_method, {})
