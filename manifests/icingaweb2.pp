...
class psick_profile::icingaweb2 (
  ...
  Hash $ido_settings                      = lookup('psick_profile::icinga2::ido_settings'),
  ...
  Hash $influxdb_settings                 = lookup('psick_profile::icinga2::influxdb_settings'),
      ...
      'icinga': {
        ...
        if $grafana_module_manage {
          ...
          if $grafana_manage {
            $grafana_defaults = {
              ...
              datasources_hash => {
                'DS_ICINGA2' => {
                  ...
                  template         => 'psick_profile/grafana/datasource.yaml.erb',
                  type             => 'influxdb',
                  access           => 'proxy',
                  org_id           => '1',
            ...
            psick_profile::grafana::user { $grafana_settings['user']:
