...
#   automatically added.
#   psick_profile::nginx::auto_conf: true
#
...
#   Check psick_profile::nginx::resources_auto_conf_hash in
...
#   Check psick_profile::nginx::options_auto_conf_hash in
#   data/common/nginx.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::nginx::resources
...
#  Hash               $options                 = {},
  ...
  if $manage {
    ...
    # Declaration of psick_profile::nginx::resources
    $resources=lookup('psick_profile::nginx::resources', Hash, $resources_lookup_method, {})
