...
#   psick_profile::influxdb::tp::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::influxdb::tp::auto_conf: true
#
...
#   Check psick_profile::influxdb::tp::resources_auto_conf_hash in
...
#   Check psick_profile::influxdb::tp::options_auto_conf_hash in
#   data/common/influxdb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::influxdb::tp::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::influxdb::tp::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::influxdb::tp::resources
    $resources=lookup('psick_profile::influxdb::tp::resources', Hash, $resources_lookup_method, {})
