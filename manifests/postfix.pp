...
#   automatically added.
#   psick_profile::postfix::auto_conf: true
#
...
#   Check psick_profile::postfix::resources_auto_conf_hash in
...
#   Check psick_profile::postfix::options_auto_conf_hash in
#   data/common/postfix.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::postfix::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::postfix::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::postfix::resources
    $resources=lookup('psick_profile::postfix::resources', Hash, $resources_lookup_method, {})
