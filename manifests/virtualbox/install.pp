# psick_profile::virtualbox::install
#
# @summary This class manages virtualbox with Tiny Puppet (tp)
#
...
#   psick_profile::virtualbox::install::options:
#     key: value
#
...
#   automatically added.
#   psick_profile::virtualbox::install::auto_conf: true
#
...
#   Check psick_profile::virtualbox::install::resources_auto_conf_hash in
...
#   Check psick_profile::virtualbox::install::options_auto_conf_hash in
#   data/common/virtualbox.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick_profile::virtualbox::install::resources
...
#
class psick_profile::virtualbox::install (
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick_profile::virtualbox::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick_profile::virtualbox::install::resources
    $resources=lookup('psick_profile::virtualbox::install::resources', Hash, $resources_lookup_method, {})
